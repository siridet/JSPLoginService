 ...
 *         &lt;element name="service" type="{urn:gndbss}gnService" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "setServiceByRoot")
public class SetServiceByRoot {
    ...
    protected JAXBElement<GnService> service;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GnService }{@code >}
     *     
     */
    public JAXBElement<GnService> getService() {
        return service;
    }
     ...
     *     
     */
    public void setService(JAXBElement<GnService> value) {
        this.service = value;
    }
